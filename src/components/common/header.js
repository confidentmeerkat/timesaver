  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-black p-6">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        ...
        <img src="/timesave_header.png" alt="timesave_header" className="h-[35px]" />
      </div>
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div>
          <Link
            to="/"
            className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-gray-500 hover:bg-white mt-4 lg:mt-0 ml-5"
          >
            Home
          </Link>
        </div>
